...
# Database Setup
#################################################
engine = create_engine('sqlite:///DATA-ENGINEERING-PROJECT/streaming1.sqlite' ,  pool_size=10, max_overflow=20)
...
def netflix():
    ...
    data1_df =  session.query(tab1.Show_ID , tab1.Type , tab1.Title , tab1.Category , tab1.Date.Added , tab1.Rating , tab1.Director , tab1.Description ).all()
